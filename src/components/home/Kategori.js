          ...
          >
            <Carousel md={0} style={{ width: 350 }}>
              <Carousel.Item interval={1000}>
                <img className='d-block w-50' src={promo1} alt='First slide' />
                <Carousel.Caption>
                  <h5 style={{ textShadow: '3px 2px 1px grey' }}>Promo disc 5% </h5>
                  <hr />
                  <p style={{ backgroundColor: '#67a47869', fontSize: '10px' }}>
                    Untuk pembelian pertama anda.
                  </p>
                </Carousel.Caption>
              </Carousel.Item>
              <Carousel.Item interval={1000}>
                <img className='d-block w-50' src={promo2} alt='Second slide' />
                <Carousel.Caption>
                  <h5 style={{ textShadow: '3px 2px 1px grey' }}>Buy 1 get 1 </h5>
                  <hr />
                  <p style={{ backgroundColor: '#67a47869', fontSize: '10px' }}>
                    Untuk setiap pembelian Aglaonema.
                  </p>
                </Carousel.Caption>
              </Carousel.Item>
              <Carousel.Item interval={1000}>
                <img className='d-block w-50' src={promo3} alt='Third slide' />
                <Carousel.Caption>
                  <h5 style={{ textShadow: '3px 2px 1px grey' }}>Min. 200 rb </h5>
                  <hr />
                  <p style={{ backgroundColor: '#67a47869', fontSize: '10px' }}>
                    Voucher gratis ongkir untuk pembelian minimal 200 ribu.
                  </p>
                </Carousel.Caption>
              </Carousel.Item>
            </Carousel>
